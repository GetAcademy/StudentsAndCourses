...
namespace StudentsAndCourses.UnitTest
{
    public class Tests
    {
        ...
        [Test]
        public void TestRegisterSameStudentTwoTimes()
        {
            var per = new Student("Per");
            var course = new Course("C#");
            course.RegisterStudent(per);
            course.RegisterStudent(per);
        ...
        [Test]
        public void TestRegisterToStudentWithSameName()
        {
            var student1 = new Student("Per");
            var student2 = new Student("Per");
            var course = new Course("C#");
            course.RegisterStudent(student1);
            course.RegisterStudent(student2);
